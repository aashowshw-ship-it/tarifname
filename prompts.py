...
- Türkçe istem Word çıktısında `... olup, özelliği;` geçişi satır sonunda parçalanmamalıdır; üretici bu geçişi non-breaking boşluklarla birlikte tutacaktır. Aynı veri üzerinde ardışık fiiller varsa ikinci fiilin nesnesini belirsiz bırakma; gerektiğinde `bahsedilen verileri` veya `söz konusu verileri` diyerek nesneyi açıkça tekrar bağla.
