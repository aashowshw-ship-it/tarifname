...
- BBF'de buluşun yapısı, kullanımı, problemi, çözümü, teknik etkisi, unsur/işlev ilişkisi, örneği, çalışma koşulu veya teknik değer/aralığı olarak verilen hiçbir bilgi detaylı açıklamadan düşürülemez. Kaynak cümle düzgünse onu özetlemek yerine doğrudan/çok yakın biçimde aktar. `eleman (1)`/`unsur (1)` gibi geçici adlandırmayı nihai referans tablosundaki gerçek unsur adı + `(1)` ile değiştir.
