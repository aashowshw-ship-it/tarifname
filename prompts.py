...
- method_claim varsa her adım metninin sonunda '(1001)' gibi numara yer alsın. Ara işlem adımları virgülle bitsin; son işlem adımının sonunda noktalama olmasın ve ardından ayrı satırda “işlem adımlarını içermesidir.” gelsin. method_claim içindeki işlem metinleri method_steps ile numara hariç birebir aynı olsun.
